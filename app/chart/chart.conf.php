 ...
 */
   ...
   * Template Constant
   */
   define('CHART_EDITOR_TEMPLATE',             TEMPLATE_DIR . '/chart.html');
   define('CHART_APPROVED_PROJECT_TEMPLATE',   TEMPLATE_DIR . '/chart_approved_project.html');
   define('CHART_LIST_TEMPLATE',               TEMPLATE_DIR . '/chart_list.html');
