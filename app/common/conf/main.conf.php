<?php
    ...
    *  CVS ID: $Id$
    *
    *  NOTES FOR EVOKNOW OPEN SOURCE SOLUTIONS TEAM
    *  ============================================
    *  You SHOULD NOT need to add anything to this file.
    *
    *  You should be only turning on/off production mode,
    *  test mode, etc. to facilitate your development efforts
    *
   ...
   */
   ...
   define('APP_CONTENTS_DIR',          DOCUMENT_ROOT . '/app_contents');
   define('EXT_DIR',                   DOCUMENT_ROOT . '/ext');
   define('TEMP_DIR',                  DOCUMENT_ROOT . '/temp');
   define('DOCUMENTS_DIR',             DOCUMENT_ROOT . '/documents');
   define('PDF_DIR',                   DOCUMENT_ROOT . '/pdf');
   ...
   define('SMARTY_DIR',                EXT_DIR . '/smarty3/libs/'); // trailing / required
   ...
   define('RELATIVE_STANDARD_APP_DIR',     '/app/standard');
