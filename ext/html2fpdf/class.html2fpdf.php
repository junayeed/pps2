...
- CSS + align = bug!
- obs: para textos de mais de 1 p�gina, talvez tenha que juntar varios $texto_artigo
...
require_once($_SERVER['DOCUMENT_ROOT'].'/ext/fpdf/class.fpdf.php');
require_once($_SERVER['DOCUMENT_ROOT'].'/ext/htmltoolkit/class.htmltoolkit.php');
...
function HTML2FPDF($orientation='P',$unit='mm',$format='Letter', $fontSize = 11)
{
//! @desc Constructor
...
//Page header
function Header( $subHeader1 = null, $subHeader2 = null)
{
//! @return void
  if ($this->titulo != '')
   {
	   ...
	   $this->Cell(30,10,$this->titulo,0,0,'R');
	   $this->SetStyle('U',false);
	   //Line break
      $this->Ln(5);
...
//	   $this->SetStyle('U',true);
	   $this->Cell(48,10,$subHeader1,0,0,'L');
	   $this->SetStyle('U',false);
	   //Line break
      $this->Ln(10);
   ...
   if($subHeader2 != '')
   {
      ...
      //Title (Underlined)
//	   $this->SetStyle('U',true);
	   $this->Cell(48,10,$subHeader2,0,0,'L');
	   $this->SetStyle('U',false);
	   //Line break
      $this->Ln(15);
...
//! @return void
    ...
    $this->Cell(0,10, 'Confidential Information. Do not share this document with anyone outside EVOKNOW.',0,0,'C');
    $this->SetY(-10);  
    $this->Cell(0,10, 'Copyright (c) 2005 EVOKNOW, Inc.',0,0,'C');
    $this->SetTextColor(0);
    //Arial italic 9
...
/// HTML parser ///
///////////////////
function WriteHTML($html, $subHeader1 = null, $subHeader2 = null)
{
//! @desc HTML parser
//! @return void
/* $e == content */
...
//  			  if (!$this->divbegin) $this->x = $this->oldx + $this->GetStringWidth($e) - $this->cMargin;
      ...
      //Start of 'if/elseif's
			if($this->titulo) { 
			    $this->titulo = $e;
				  $this->Header($subHeader1, $subHeader2);
			}
...
*/
  $align = array('left'=>'L','center'=>'C','right'=>'R','top'=>'T','middle'=>'M','bottom'=>'B');
    ...
    case 'ADDRESS': 
      ...
      $this->SetFontSize(8); 
		  break;
		case 'HR': //editado para esta vers�o
...
//			else $Width = $this->w - $this->lMargin - $this->rMargin;
      ...
      elseif($this->addresstag) $this->textbuffer[] = array("\n",$this->HREF,$this->currentstyle,$this->colorarray,$this->currentfont);
			...
			break;
		case 'P':
  		if ($this->tablestart) break; //especial para esta vers�o
		  $this->pbegin=true;
