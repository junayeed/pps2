...
function addNewComponent(com_type,buttonClick)
{
    ...
    var td_total_gob    = '<td><input type="text" name="total_gob_'+COMPONENT_ROW_ID+'"    id="total_gob_'+COMPONENT_ROW_ID+'"    value="" class="span12" onchange="updateCumulativeProgressRow(this.value,\'gob\','+COMPONENT_ROW_ID+')"  /><br>\n\
                               <input type="text" name="total_gob_fe_'+COMPONENT_ROW_ID+'" id="total_gob_fe_'+COMPONENT_ROW_ID+'" value="" class="span12" onchange="updateCumulativeProgressRow(this.value,\'gob_fe\','+COMPONENT_ROW_ID+')" /></td>';
    var td_pa_gob       = '<td><input type="text" name="pa_gob_'+COMPONENT_ROW_ID+'"       id="pa_gob_'+COMPONENT_ROW_ID+'"       value="" class="span12" onchange="updateCumulativeProgressRow(this.value,\'rpa_through_gob\','+COMPONENT_ROW_ID+')" /></td>';
    var td_pa_spc_acnt  = '<td><input type="text" name="pa_spc_acnt_'+COMPONENT_ROW_ID+'"  id="pa_spc_acnt_'+COMPONENT_ROW_ID+'"  value="" class="span12" onchange="updateCumulativeProgressRow(this.value,\'rpa_special_account\','+COMPONENT_ROW_ID+')" /></td>';
    var td_pa_dpa       = '<td><input type="text" name="pa_dpa_'+COMPONENT_ROW_ID+'"       id="pa_dpa_'+COMPONENT_ROW_ID+'"       value="" class="span12" onchange="updateCumulativeProgressRow(this.value,\'dpa\','+COMPONENT_ROW_ID+')" /></td>';
    var td_own_fund     = '<td><input type="text" name="own_fund_'+COMPONENT_ROW_ID+'"     id="own_fund_'+COMPONENT_ROW_ID+'"     value="" class="span12" onchange="updateCumulativeProgressRow(this.value,\'own_fund\','+COMPONENT_ROW_ID+')" /><br>\n\
                               <input type="text" name="own_fund_fe_'+COMPONENT_ROW_ID+'"  id="own_fund_fe_'+COMPONENT_ROW_ID+'"  value="" class="span12" onchange="updateCumulativeProgressRow(this.value,\'own_fund_fe\','+COMPONENT_ROW_ID+')" /></td>';
    var td_other        = '<td><input type="text" name="other_'+COMPONENT_ROW_ID+'"        id="other_'+COMPONENT_ROW_ID+'"        value="" class="span12" onchange="updateCumulativeProgressRow(this.value,\'other\','+COMPONENT_ROW_ID+')" /><br>\n\
...
function createComponentRow(row_id,com_type)
{
    ...
    (
        {                                      
            ...
            data: "totalyear="+tot_year+"&PI="+pid+'&component_type='+com_type+'&rdpp=1',
            dataType: 'json',
            success: function(responseText)
            {
                //alert(responseText)
...
function deleteComponent(elemID,component_type)
{
    ...
    if (annexID)
    {
        if ( doConfirm('The component will be deleted.\n' + PROMPT_DELETE_CONFIRM) )
        {
            ...
            (
                {
                    url: 'rdpp_manager.php?cmd=deletecomponent',
    ...
    var component_details_breakdown_div = '<div class="total_cost_breakdown_container" id="total_cost_breakdown_container_'+YEAR_COUNT+'">\n\
                                               ...
                                               <table id="total_cost_breakdown_tbl_'+YEAR_COUNT+'" class="table table-striped table-bordered table-hover table_bug_report">\n\
                                                   <thead>\n\
                                                       ...
                                                       <tr>\n\
                                                           <th class="span3 center" rowspan="3">Unit</th>\n\
                                                           <th class="span3 center" rowspan="3">Quantity</th>\n\
                                                   ...
                                                   <tr><td colspan="9">Reveue Component&nbsp;</td></tr>\n\
                                                   </tbody>\n\
                                                   <tbody id="Capital_Component_total_cost_breakdown_content_'+YEAR_COUNT+'">\n\
                                                       <tr>\n\
                                                           <td>\n\
                                                               <input type="text" id="Revenue_Component_sub_total_unit_'+YEAR_COUNT+'" name="Revenue_Component_sub_total_unit_'+YEAR_COUNT+'" class="span12" readonly >\n\
                                                           </td>\n\
                                                           <td>\n\
                                                               <input type="text" id="Revenue_Component_sub_total_qty_'+YEAR_COUNT+'" name="Revenue_Component_sub_total_qty_'+YEAR_COUNT+'" class="span12" readonly >\n\
                                                           </td>\n\
                                                           <td>\n\
                                                   ...
                                                   <tfoot>\n\
                                                       <tr  style="background-color: #FFFFFF;">\n\
                                                           <td>\n\
                                                               <input type="text" id="Capital_Component_sub_total_unit_'+YEAR_COUNT+'" name="Capital_Component_sub_total_unit_'+YEAR_COUNT+'" class="span12" readonly >\n\
                                                           </td>\n\
                                                           <td>\n\
                                                               <input type="text" id="Capital_Component_sub_total_qty_'+YEAR_COUNT+'" name="Capital_Component_sub_total_qty_'+YEAR_COUNT+'" class="span12" readonly >\n\
                                                           </td>\n\
                                                           <td>\n\
...
function adjustComponentRowPerYear(year)
{
    ...
    //var component_type = com_type.replace(' ', '_');
        ...
        for(var i=0; i<componentRowIDArray.length; i++)
        {
            ...
            var td_total_unit    = '<td><input type="text" name="unit_'+year+'_'+componentRowIDArray[i]+'"                  id="unit_'+year+'_'+componentRowIDArray[i]+'"                 value="" class="span12" onkeypress="return isNumberKey(event);" onChange="calculateComponentYearTotal('+year+', '+componentRowIDArray[i]+');updateComDetail(this.value,\'unit\','+year+','+componentRowIDArray[i]+');" /><br>\n\
                                    </td>';
            var td_total_qty     = '<td><input type="text" name="qty_'+year+'_'+componentRowIDArray[i]+'"                  id="qty_'+year+'_'+componentRowIDArray[i]+'"                 value="" class="span12" onkeypress="return isNumberKey(event);" onChange="calculateComponentYearTotal('+year+', '+componentRowIDArray[i]+');updateComDetail(this.value,\'qty\','+year+','+componentRowIDArray[i]+');" /><br>\n\
                                    </td>';
            ...
            $('<tr id="tr_'+year+'_'+componentRowIDArray[i]+'">'+ td_total_unit + td_total_qty + td_total_gob + td_pa_gob + td_pa_spc_acnt + td_pa_dpa 
...
function addYearWiseNewComponentDetailsRow(com_type, year, elemID)
{
    ...
    var td_total_unit    = '<td><input type="text" name="unit_'+year+'_'+elemID+'"                  id="unit_'+year+'_'+elemID+'"                 value="" class="span12" onkeypress="return isNumberKey(event);" onChange="checkFEValue('+year+', '+elemID+',\''+UNIT+'\'); updateComDetail(this.value,\'unit\','+year+','+elemID+');" /></td>';
    var td_total_qty     = '<td><input type="text" name="qty_'+year+'_'+elemID+'"                  id="qty_'+year+'_'+elemID+'"                 value="" class="span12" onkeypress="return isNumberKey(event);" onChange="checkFEValue('+year+', '+elemID+',\''+QTY+'\'); updateComDetail(this.value,\'qty\','+year+','+elemID+');" /></td>';
    ...
    $('<tr id="tr_'+year+'_'+elemID+'">'+td_total_unit+td_total_qty+ td_total_gob + td_pa_gob + td_pa_spc_acnt + td_pa_dpa 
                                                       + td_own_fund + td_other + td_comp_total + td_hidden 
...
function updateCumulativeProgressRow(thisValue,thisField,elemID)
{
     var annexID        = $('#annex_id_'+elemID).val();
    ...
    (
        {                                      
            url: 'http://'+document.domain+'/app/ajax/ajax.php?cmd=updateCumulativeProgressRow',
            data: "annex_id="+annexID+"&thisField="+thisField+'&thisValue='+thisValue+'&PI='+PI,
            dataType: 'json',
            success: function(responseText)
            {
                if(responseText)
...
function deleteYear()
{
    ...
    if ( doConfirm('The component and year details will be deleted.\n' + PROMPT_DELETE_CONFIRM) )
    {
        ...
        (
            {
                url: 'rdpp_manager.php?cmd=deleteyear',
