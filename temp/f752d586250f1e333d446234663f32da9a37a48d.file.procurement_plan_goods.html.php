<?php /* Smarty version Smarty-3.1.17, created on 2014-08-22 05:55:50
         compiled from "E:\xampp\htdocs\pps2\app_contents\project_manager\procurement_plan_goods.html" */ ?>
<?php /*%%SmartyHeaderCode:2865253f6008ddbb633-08449189%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '2865253f6008ddbb633-08449189',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.17',
  'unifunc' => 'content_53f6008deab158_63760962',
  'variables' => 
  array (
...
<?php if ($_valid && !is_callable('content_53f6008deab158_63760962')) {function content_53f6008deab158_63760962($_smarty_tpl) {?><div id="main-content" class="clearfix">
    <head>
                    ...
                    <div class="control-group">
                        <div class="span12">
                            <table id="goods_tbl" class="table table-striped table-bordered table-hover table_bug_report">
                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="8" align="right" class="bold">Grand Total</td>
                                        <td colspan="5"><input type="text" name="Goods_total" id="Goods_total" value="0.00" class="span4 bold" /></td>
                                    </tr>
                                    <tr>
                                        <td colspan="13"><a href="javascript:void(0)" onClick="addNewProcuremtPlanRow('goods_tbl', 'Goods');">Add New Row</a></td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
