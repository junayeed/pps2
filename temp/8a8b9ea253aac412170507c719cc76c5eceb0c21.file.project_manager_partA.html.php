<?php /* Smarty version Smarty-3.1.17, created on 2014-05-15 08:55:41
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select multiple class="chzn-select divisions" id="location_divisions[]"  name="location_divisions[]" data-placeholder="Choose a Division...">
                            <option value=""></option>
                            <?php echo smarty_function_html_options(array('values'=>$_smarty_tpl->tpl_vars['divisionList']->value,'output'=>$_smarty_tpl->tpl_vars['divisionList']->value),$_smarty_tpl);?>
...
?>
            ...
            alert(<?php echo $_smarty_tpl->tpl_vars['item']->value->location_id;?>
);
